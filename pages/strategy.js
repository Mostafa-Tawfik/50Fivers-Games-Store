...
export async function getStaticProps() {
  ...
  const res = await fetch(`${apiRoot}?${process.env.rawgkey}&genres=10&metacritic=70,100&dates=2021-01-01,2022-06-01&ordering=-added&ordering=-metacritic`)
